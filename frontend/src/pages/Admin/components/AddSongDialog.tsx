...
const AddSongDialog = () => {
  ...
  const audioInputRef = useRef<HTMLInputElement | null>(null); // Updated type to match input element
  const imageInputRef = useRef<HTMLInputElement | null>(null); // Updated type to match input element
